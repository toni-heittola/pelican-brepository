...
- title
- url
- type, valid values [audio, model, database, git, python, jquery, php, c, cplusplus, html5, python-package, matlab-package, latex, word, doc] to add more types use BREPOSITORY_TYPE_ICONS global variable
- version
- package-type
- size
- DOI
